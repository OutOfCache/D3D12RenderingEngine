...
private:
  ...
  gims::HLSLProgram           m_graphicsProgram;
  ...
  CD3DX12_GPU_DESCRIPTOR_HANDLE m_offscreenTarget_GPU_RTV;
  ...
  {
    m_graphicsProgram =
        HLSLProgram("../../../Tutorials/T16ComputeShaderPostProcess/Shaders/Triangle.hlsl", "VS_main", "PS_main");

    D3D12_GRAPHICS_PIPELINE_STATE_DESC psoDesc = {};
    psoDesc.InputLayout                        = {};
    psoDesc.pRootSignature                     = m_graphicsRootSignature.Get();
    psoDesc.VS                                 = CD3DX12_SHADER_BYTECODE(m_graphicsProgram.getVertexShader().Get());
    psoDesc.PS                                 = CD3DX12_SHADER_BYTECODE(m_graphicsProgram.getPixelShader().Get());
  ...
  {
    m_computeShader = HLSLShader(
        L"../../../Tutorials/T16ComputeShaderPostProcess/Shaders/ComputeShaderPostProcess.hlsl", "main", "cs_5_1");
...
public:
      ...
      : DX12App(createInfo)
  {
...

    {
      ...
      m_offscreenTarget_GPU_RTV =
          CD3DX12_GPU_DESCRIPTOR_HANDLE(m_rtvDescriptorHeap->GetGPUDescriptorHandleForHeapStart(), 0, descSize);
    }
